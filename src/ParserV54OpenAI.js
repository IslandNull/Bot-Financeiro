...
function buildParserV54OpenAISystemPrompt_(context) {
    ...
    return [
        ...
        '- Use só enumerações permitidas.',
        '- Use só IDs dos dicionários canônicos abaixo.',
        ...
        '- Do not default escopo to Casal for ambiguous personal categories.',
        '- Use the authorized Telegram user as defaultPessoa.',
        '- Use category defaults for escopo when category semantics are clearly shared.',
        '- For ambiguous personal categories, default escopo to defaultPessoa.',
        '- Only use escopo=Casal when text or category strongly indicates shared household expense.',
        '- If escopo cannot be inferred safely, return low confidence/warnings and do not guess shared responsibility.',
        '',
