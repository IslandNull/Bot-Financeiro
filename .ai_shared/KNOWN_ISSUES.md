...
- **Webhook Secret Deployment:** Local code requires `WEBHOOK_SECRET` before Telegram payload routing, but the real Apps Script Script Property and Val.town forwarding contract still need production verification.
