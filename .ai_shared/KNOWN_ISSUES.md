...
- **V53 Deprecated Prototype:** The 2026-04-27 planning premise is V54-only MVP. V53 was not real production and is not a mandatory fallback. Current code/scripts still reference V53-era files and sheets, so removal or renaming must be handled as a separate cleanup/refactor phase, not as an automatic spreadsheet action.
